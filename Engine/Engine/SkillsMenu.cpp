...
SkillsMenu* SkillsMenu::instance()
{
	static SkillsMenu menu;
	return &menu;
}
void SkillsMenu::init()
{
	...
	cmdWindow.init();
	cmdWindow.setHandle("commandWindow");
	cmdWindow.setTranslate(310,180,0);
	cmdWindow.setScale(0.8f, 0.6f, 0.0f);
...
void SkillsMenu::shutdown()
{

}

int SkillsMenu::update()
{
